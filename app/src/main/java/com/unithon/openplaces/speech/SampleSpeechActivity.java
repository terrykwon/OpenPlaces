package com.unithon.openplaces.speech;
...
import com.unithon.openplaces.Authentication;
...
public class SampleSpeechActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_speech_sample);
    ...
    static class RecognitionHandler extends Handler {
        private final WeakReference<SampleSpeechActivity> mActivity;

        RecognitionHandler(SampleSpeechActivity activity) {
            mActivity = new WeakReference<SampleSpeechActivity>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            SampleSpeechActivity activity = mActivity.get();
            if (activity != null) {
